    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-50 bg-glow-radial px-4 py-10">
      <PageTransition className="w-full max-w-sm">
        <div className="mb-8">
          ...
          <h1 className="mt-5 text-center font-display text-xl font-bold text-slate-900">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-2xl border border-slate-300 bg-white px-4 py-3.5 text-base text-slate-900 focus:border-accent focus:outline-none"
              />
            </div>
